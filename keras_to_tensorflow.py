...
parser.add_argument('-input_model_file', action="store", 
                    dest='input_model_file', type=str, default='./imdb_retrain_age_gender_model_0612/weights.imdb_224_mobv2_30-3.51.hdf5')
parser.add_argument('-output_model_file', action="store", 
                    dest='output_model_file', type=str, default='./imdb_retrain_age_gender_model_0612/weights.imdb_224_mobv2_30-3.51.pb')
